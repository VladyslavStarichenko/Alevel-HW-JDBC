...
public class CategoryDao {
    ...
    public static void createCategory(Connection connection, String name) {
        String sqlInsertion = "INSERT INTO category (category_name) VALUES (?)";
    ...
    public static void createCategoryWithId(Connection connection, String name, Integer id) {
        String sqlInsertion = "INSERT INTO category (category_id, category_name) VALUES (?,?)";
        PreparedStatement statement;
        {
            try {
                statement = connection.prepareStatement(sqlInsertion);
    ...
    public static List<Integer> getCategoryByName(Connection connection, String name) {
        String sqlSelectByName = "SELECT category_id FROM  category WHERE category_name = ?";
